...
for calibrator in ('1331+305=3C286', 'J1751+0939', 'J1922+1530'):
    for corr in ('RR','LL'):
        output = myimagebase = imagename = '{0}_SB4_QbandAarray_cont_spws_{1}_continuum_cal_dirty'.format(calibrator, corr)
        tclean(vis=vis,
               imagename=imagename,
               field=calibrator,
               spw=contspw,
...
"""
output = myimagebase = imagename = 'W51e2w_SB4_QbandAarray_cont_spws_raw_continuum_cal_clean'
tclean(vis=vis,
       imagename=imagename,
       field='W51e2w',
       spw=contspw,
...
output = myimagebase = imagename = 'W51North_SB4_QbandAarray_cont_spws_raw_continuum_cal_clean'
tclean(vis=vis,
       imagename=imagename,
       field='W51 North',
       spw=contspw,
...
"""
output = myimagebase = imagename = 'W51e2w_SB4_QbandAarray_cont_spws_continuum_cal_clean_2terms'
tclean(vis=vis,
       imagename=imagename,
       field='W51e2w',
       spw=contspw,
...
output = myimagebase = imagename = 'W51North_SB4_QbandAarray_cont_spws_continuum_cal_clean_2terms'
tclean(vis=vis,
       imagename=imagename,
       field='W51 North',
       spw=contspw,
