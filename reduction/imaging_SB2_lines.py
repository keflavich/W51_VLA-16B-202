...
line_vis = vis = '16B-202.sb32957824.eb33105444.57748.63243916667.ms'
...
for line, freq, spw in (
    ...
    output = imagename = myimagebase = 'W51e2w_SB2_QbandAarray_{0}'.format(line)
    ...
    output = imagename = myimagebase = 'W51North_SB2_QbandAarray_{0}'.format(line)
