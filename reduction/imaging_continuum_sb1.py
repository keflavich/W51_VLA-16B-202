...
"""
output = myimagebase = imagename = 'W51e2w_SB1_QbandAarray_cont_spws_raw_continuum_cal_clean'
tclean(vis=vis,
       imagename=imagename,
       field='W51e2w',
       spw=contspw,
...
output = myimagebase = imagename = 'W51North_SB1_QbandAarray_cont_spws_raw_continuum_cal_clean'
tclean(vis=vis,
       imagename=imagename,
       field='W51 North',
       spw=contspw,
...
"""
output = myimagebase = imagename = 'W51e2w_SB1_QbandAarray_cont_spws_continuum_cal_clean_2terms'
tclean(vis=vis,
       imagename=imagename,
       field='W51e2w',
       spw=contspw,
...
output = myimagebase = imagename = 'W51North_SB1_QbandAarray_cont_spws_continuum_cal_clean_2terms'
tclean(vis=vis,
       imagename=imagename,
       field='W51 North',
       spw=contspw,
