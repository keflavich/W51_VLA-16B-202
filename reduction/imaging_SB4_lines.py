...
line_vis = vis = '16B-202.sb32957824.eb33234671.57760.62953023148.ms'
...
for line, freq, spw in (
    ...
    output = imagename = myimagebase = 'W51e2w_SB4_QbandAarray_{0}'.format(line)
    ...
    output = imagename = myimagebase = 'W51North_SB4_QbandAarray_{0}'.format(line)
